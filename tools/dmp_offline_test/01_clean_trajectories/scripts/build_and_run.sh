...
mkdir -p build data weights 01_clean_trajectories/plots

echo "Compiling dmp_offline_test with official sources ($PKG_DIR)..."
g++ -std=c++17 -O2 \
    -I "$PKG_DIR/include" \
    -I 01_clean_trajectories/scripts \
    -I common/include \
    -I/usr/include/eigen3 \
    01_clean_trajectories/scripts/test_core_offline.cpp \
...
echo "To plot a trajectory: python3 01_clean_trajectories/scripts/plot_dmp_test.py <trajectory_name>"
